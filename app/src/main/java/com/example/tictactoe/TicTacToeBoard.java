...
public class TicTacToeBoard extends View {
    ...
    private void drawnMarkers(Canvas canvas) {
        for(int r = 0 ; r < 3; r++){
            for(int c = 0 ; c < 3 ; c++){
    ...
    private void drawHorizontaleLine(Canvas canvas , int row , int col){
        canvas.drawLine(col ,
    ...
    private void drawWinningLine(Canvas canvas){
        ...
        int col = game.getWinType()[1];
            ...
            switch(game.getWinType()[2]){
                case 1:
                    drawHorizontaleLine(canvas , row, col);
                    break;
                case 2:
